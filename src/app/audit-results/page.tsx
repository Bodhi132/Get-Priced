...
export default function AuditResultsPage() {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `AI-Audit-Report-${data?.auditId?.slice(0, 8) || 'Results'}.pdf`;
  ...
  const { total_monthly_savings, total_annual_savings, per_tool_breakdown, strategic_summary, auditId } = data;
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb] text-gray-600 selection:bg-[#51bc8f]/30 selection:text-[#2d7a5a] pb-32">
      <nav className="max-w-5xl mx-auto px-6 py-8 flex items-center justify-between relative z-10 no-pdf">
      ...
      <div ref={reportRef}>
        <main className="max-w-4xl mx-auto px-6 pt-10">
          ...
          <section className="mb-24">
            ...
            >
              {per_tool_breakdown.map((tool, idx) => {
      ...
      <section className="mt-12 mb-32 no-pdf max-w-4xl mx-auto px-6">
